...
void Plik_z_adresatami::dopiszAdresataDoPliku(Adresat adresat)
{
    ...
    {
        liniaZDanymiAdresata = metoda_pomocnicza.zamienDaneAdresataNaLinieZDanymiOddzielonymiPionowymiKreskami(adresat);
...
int Plik_z_adresatami::pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(string daneJednegoAdresataOddzielonePionowymiKreskami)
{
    ...
    int idAdresata = metoda_pomocnicza.konwersjaStringNaInt(metoda_pomocnicza.pobierzLiczbe(daneJednegoAdresataOddzielonePionowymiKreskami, pozycjaRozpoczeciaIdAdresata));
    return idAdresata;
}
